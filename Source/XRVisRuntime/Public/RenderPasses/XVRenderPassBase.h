 ...
 *
 */
struct XRVISRUNTIME_API FRenderPassInputParams
{
 ...
 *
 */
struct XRVISRUNTIME_API FRenderPassOutputParams
{
 ...
 *
 */
class XRVISRUNTIME_API FXVRenderPassBase
{
protected:
	bool bNeverCull = false;

	FXVRenderPassBase() = default;
	virtual ~FXVRenderPassBase() = default;
